        ...
        <div class="row">
            <div class="col-lg-6 d-flex align-items-center">
                <div class="contact-info">
                    ...
                    <div class="box">
                        <div class="icon">
                            <a href="tel:+918122728122"><i class="fa-solid fa-phone-volume"></i></a>
                        </div>
                        <div class="text">
                            <a href="tel:+918122728122">
                                <h3>Phone</h3>
                    ...
                    <a href="https://www.google.com/maps/@12.620581,80.1797378,17z?entry=ttu">
                        <div class="box">
                            <div class="icon">
