...
<footer class="footer-area ptb-70">
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-md-6 footerSide1">
        <div class="footerSide1Box">
          ...
          <div class="social-icons-footer d-flex align-items-center">
             ...
             <a href="https://www.linkedin.com/in/uph-djg-tamayo-medical-university-381807277/"><i
      ...
      <div class="col-lg-3 col-md-6 footerSide2">
        <div class="quickLinks">
          <h3>Quick link</h3>
          <ul class="quicklinks-line" id="">
            <li>
              <a href="https://www.uphdjgtmedicaluniversity.com/">Home</a>
            </li>
            <li>
              <a href="https://uphdjgtmedicaluniversity.com/about-us/">About Us</a> </li>
            <li><a href="https://uphdjgtmedicaluniversity.com/mbbs-in-philippines/">MBBS in Phillippines</a> </li>
      ...
      <div class="col-lg-3 col-md-6 footerContactform">
